...
use App\Form\CommentsBlog1Type;
...
class CommentsBlogController extends AbstractController
{
    ...
    #[Route('/new', name: 'app_comments_blog_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        $commentsBlog = new CommentsBlog();
        $form = $this->createForm(CommentsBlog1Type::class, $commentsBlog);
        ...
        return $this->render('comments_blog/new.html.twig', [
            'comments_blog' => $commentsBlog,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_comments_blog_show', methods: ['GET'])]
    public function show(CommentsBlog $commentsBlog): Response
    {
        return $this->render('comments_blog/show.html.twig', [
            'comments_blog' => $commentsBlog,
        ]);
    }
    ...
    #[Route('/{id}', name: 'app_comments_blog_delete', methods: ['POST'])]
