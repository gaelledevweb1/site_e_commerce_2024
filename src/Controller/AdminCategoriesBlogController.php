...
#[Route('/admin/categories/blog')]
class AdminCategoriesBlogController extends AbstractController
{
    #[Route('/', name: 'app_admin_categories_blog_index', methods: ['GET'])]
    public function index(CategoriesBlogRepository $categoriesBlogRepository): Response
    {
        return $this->render('admin_categories_blog/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $form = $this->createForm(CategoriesBlogType::class, $categoriesBlog);
        ...
        return $this->render('admin_categories_blog/new.html.twig', [
            'categories_blog' => $categoriesBlog,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_categories_blog_show', methods: ['GET'])]
    public function show(CategoriesBlog $categoriesBlog): Response
    {
        return $this->render('admin_categories_blog/show.html.twig', [
            'categories_blog' => $categoriesBlog,
        ]);
    }
    ...
    public function edit(Request $request, CategoriesBlog $categoriesBlog, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_categories_blog/edit.html.twig', [
            'categories_blog' => $categoriesBlog,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_categories_blog_delete', methods: ['POST'])]
